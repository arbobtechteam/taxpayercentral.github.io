  ...
  const defaultPlans = [
    {
      ...
      features: ["1040 form", "editable", "unlimited downloads", "Basic Assistance"],
    },
    {
      name: "Business",
      price: "$37.99",
      duration: "Monthly",
      mainFeature: "Suited for Production",
      features: ["personal and bussiness", "editable", "unlimited downloads", "Priority Assistance"],
      featured: true,
    },
    {
      name: "Enterprise",
      ...
      features: ["bussniess", "fully editable", "unlimited downloads", "Personal Assistance"],
    },
  ];
