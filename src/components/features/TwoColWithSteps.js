...
export default ({
  ...
  const defaultSteps = [
    {
      heading: "Register",
      description: "Create an account with us using Email or Phone Number."
    },
    {
      heading: "Fill Form",
      description: "Enter your tax information online."
    },
    {
      heading: "Sign",
      description: "Electronically sign and file your return."
    },
    {
      heading: "Download",
      description: "Print your return for recordkeeping."
    }
  ];
